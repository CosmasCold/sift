    ...
    <footer className="border-t border-surface-700/50 bg-surface-800/60 backdrop-blur-xl py-6 px-4 mt-auto">
      <div className="max-w-6xl mx-auto flex flex-col sm:flex-row justify-between items-center gap-4 text-sm text-surface-400">
        <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-6">
          <div>© {new Date().getFullYear()} Sift</div>
          <span className="hidden sm:inline text-surface-500">·</span>
          <span className="text-surface-500">Built with care. Powered by Groq, Supabase, and Vercel.</span>
        </div>
        <div className="flex gap-6 flex-wrap justify-center">
          <Link href="/blog" className="hover:text-accent-400 transition-colors">Blog</Link>
          <Link href="/changelog" className="hover:text-accent-400 transition-colors">Changelog</Link>
